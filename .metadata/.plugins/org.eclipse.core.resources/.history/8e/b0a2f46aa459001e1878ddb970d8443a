...
public class MemoAthenticateServiceImpl implements MemoAthenticateService {
	...
	private MemoAthenticateDAO dao = MemoAthenticateDAOImpl.getMemoAthenticateDAO();
	
	public static synchronized MemoAthenticateService getMemoAthenticateService() {
